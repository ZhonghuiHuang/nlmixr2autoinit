...
- [`print(`*`<getPPKinits>`*`)`](https://init.nlmixr2auto.org/reference/print.getPPKinits.md)
  :
...
- [`ka_wanger_nelson()`](https://init.nlmixr2auto.org/reference/ka_wanger_nelson.md)
...
- [`getsigma()`](https://init.nlmixr2auto.org/reference/getsigma.md) :
...
- [`getOmegas()`](https://init.nlmixr2auto.org/reference/getOmegas.md) :
...
- [`approx.vc()`](https://init.nlmixr2auto.org/reference/approx.vc.md) :
...
- [`eval_perf_1cmpt()`](https://init.nlmixr2auto.org/reference/eval_perf_1cmpt.md)
...
- [`hybrid_eval_perf_1cmpt()`](https://init.nlmixr2auto.org/reference/hybrid_eval_perf_1cmpt.md)
...
- [`processData()`](https://init.nlmixr2auto.org/reference/processData.md)
...
- [`trapezoidal_linear()`](https://init.nlmixr2auto.org/reference/trapezoidal_linear.md)
  : Linear trapezoidal rule

- [`trapezoidal_linear_up_log_down()`](https://init.nlmixr2auto.org/reference/trapezoidal_linear_up_log_down.md)
